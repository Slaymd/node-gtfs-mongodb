# Node-GTFS for MongoDB updated

## Note from Slaymd about the original package

> The original package switched to `SQLite`.
> Here is a forked version with dependencies and hot fixes keeping the `MongoDB` integration.
> For the SQLite version : [Original package by BlinkTagInc](https://github.com/blinktaginc/node-gtfs)
